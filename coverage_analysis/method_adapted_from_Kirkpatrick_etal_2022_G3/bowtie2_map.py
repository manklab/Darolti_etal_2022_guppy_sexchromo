        ...
        for sample in filedictionary:
            for file in filedictionary[sample]: 
                ...
                if file.endswith("R1.fastq"):
                    ...
                    reverse_fastq = file
                outfile = file.split("_")[0]+"_"+genomeID+"_bowtie2.sam"
                stderr = file.split("_")[0]+"_"+genomeID+"_stderr.txt"
            command = ["bowtie2 -q --phred33 -p 12 --local -x "+genome+" -1 "+forward_fastq+" -2 "+reverse_fastq+" -S "+outfile+" >& "+stderr]
